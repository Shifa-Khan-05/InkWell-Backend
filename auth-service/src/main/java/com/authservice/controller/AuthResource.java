...
public class AuthResource {
    ...
    public ResponseEntity<UserResponseDTO> updateProfileWithImage(
        ...
        return ResponseEntity.ok(authService.updateProfileWithFile(userId, fullName, username, bio, age, password, image));
    }
